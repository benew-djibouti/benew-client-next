  ...
  async headers() {
    ...
    const buildDynamicPageCSP = (includeAnalytics = false) => {
      const baseCSP = [
        ...
        `script-src 'self' ${isDev ? "'unsafe-eval'" : ''} 'unsafe-inline' https://*.googletagmanager.com https://*.google-analytics.com https://unpkg.com https://connect.facebook.net blob:`,
        "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com blob:",
        `img-src 'self' https://res.cloudinary.com${includeAnalytics ? ' https://www.google-analytics.com https://www.googletagmanager.com https://www.facebook.com' : ''} data:`,
        "font-src 'self' https://fonts.gstatic.com data:",
        `connect-src 'self' https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.doubleclick.net https://unpkg.com https://*.cloudinary.com https://*.sentry.io https://o4498048.ingest.sentry.io https://connect.facebook.net https://*.facebook.com https://*.facebook.net`,
