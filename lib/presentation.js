...
export const categoryContents = {
  vision: {
    ...
    paragraphs: [
      ...
      'Notre mission est claire : proposer des solutions adaptées avec un impact positif.',
      "Et tracer la voie vers l'excellence et le bien-être personnel, chaque jour un peu plus.",
  ...
  offre: {
    title: "L'offre",
    paragraphs: [
      "Nous vous proposons des magasins en ligne, appelés aussi boutiques e-commerce ou sites de vente en ligne, sous forme d'abonnement.",
